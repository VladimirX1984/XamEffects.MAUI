...
namespace XamEffects.Droid
{
    public class TouchEffectPlatform : Microsoft.Maui.Controls.Platform.PlatformEffect//PlatformEffect<ViewGroup, View>
    {
        ...
        void SetEffectColor()
        {
            ...
            // TODO Xamarin.Forms.Color.Default больше не поддерживается. Подробности см. в https://learn.microsoft.com/en-us/dotnet/maui/migration/forms-projects#color-changes
            /*if (color == new Microsoft.Maui.Graphics.Color(-1.0f, -1.0f, -1.0f, -1.0f)) {
                return;
            }*/
        ...
        RippleDrawable CreateRipple(Color color)
        {
            ...
            {
                var mask = new ColorDrawable(Colors.White.ToAndroid());
