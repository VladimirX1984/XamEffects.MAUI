...
{
    public class Commands : RoutingEffect
    {
        ...
        public static void SetViewTap(View view, ICommand value)
        {
            if (!view.Effects.Any(it => it as Commands != null))
            {
                view.Effects.Add(new Commands());
            }
            SetTap(view, value);
        }
        ...
        public static void SetViewTapParameter(View view, object value)
        {
            if (!view.Effects.Any(it => it as Commands != null))
            {
                view.Effects.Add(new Commands());
            }
            SetTapParameter(view, value);
        }
